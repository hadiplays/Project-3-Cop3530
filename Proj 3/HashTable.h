...
class HashTable {
    ...
    // list of string with its corresponding hash codes
    unordered_map<unsigned int, string> decoded;

    // for testing, list of all keys within data set
...
public:
    ...
    vector<string> top10Deaths();
    vector<string> top10UnderageDeaths();
};
